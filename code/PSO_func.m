...
% -- input meaning
% fhd = function, Dimension = dimension, Particle_Number = population size,
% Max_Gen = max iterations, VRmin = space minimum, VRmax = space maximum,
% varargin = function numbers
% -- output meaning
% gbest = bestest input, gbestval = output of bestest input, 
% fitcount = function evaluations
% -- feval use
% matrix = dimension by row, population by column
% feval(matrix, varargin{:})
